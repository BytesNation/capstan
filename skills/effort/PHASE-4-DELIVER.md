...
2. Dispatch the Courier. It packages what ships, drafts the recipient briefs, writes the knowledge-base note, and reports the note's absolute path. Capstan never runs git in the knowledge base.
