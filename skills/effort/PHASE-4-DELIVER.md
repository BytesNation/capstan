...
1. Where the repository declares a version, ask whether this effort changes it, and record the answer in `decisions.md` in the document home either way, including a no. Where it does, write the new value and commit it. Do not push it — the close-out step below hands that push to the operator, the same way it already hands over the note.
