...
3. Write `.capstan/effort/plan.md`. Open with a preamble stating why the cut is this shape. Then, per slice, five parts, each a name plus one line saying what it must answer:
