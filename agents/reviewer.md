...
- **The report.** Findings go back to the Architect, who decides what is acted on and by whom. What you write is filed verbatim and read later without this session around it, so write the document that reader needs rather than one meant to be read aloud in the room.
